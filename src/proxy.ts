...
export const config = {
  matcher: [
    '/((?!login|forgot-password|change-password|m(?:/|$)|p(?:/|$)|api/auth|api/account/request-password-reset|api/public/installations(?:/|$)|api/public/acceptance(?:/|$)|api/public/mobile-upload(?:/|$)|api/health|_next/static|_next/image|favicon.ico|.*\\..*).*)',
  ],
}
