  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={`Pracownik ${employeeName} zostanie ukryty z listy. Dane historyczne zostaną zachowane. Możesz przywrócić go później.`}
        confirmLabel="Ukryj"
        loading={loading}
      ...
      <ConfirmDialog
        ...
        description={`Czy na pewno chcesz trwale usunąć pracownika ${employeeName}? Ta operacja jest nieodwracalna. Pracownicy z danymi historycznymi nie mogą zostać usunięci.`}
