...
import { InstallationCatalogValidationError, reorderInstallationScopeProducts } from '@/lib/installations/catalog-service'
...
export async function PUT(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    await reorderInstallationScopeProducts(prisma, scopeId, body.orderedIds)
