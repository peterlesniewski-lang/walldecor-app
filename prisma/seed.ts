...
const ACCOUNT_CATEGORIES = [
  {
    ...
    subCategories: [
      ...
      { name: 'Facebook/Instagram Ads', order: 4 },
      { name: 'Influencer Marketing', order: 5 },
      { name: 'Email Marketing', order: 6 },
      { name: 'Targi/Wystawy', order: 7 },
      { name: 'Materiały reklamowe', order: 8 },
    ],
  },
  {
  ...
  },
  {
    ...
    order: 4,
    subCategories: [
      { name: 'Pracownik 1', order: 1 },
      { name: 'Pracownik 2', order: 2 },
      { name: 'Pracownik 3', order: 3 },
      { name: 'Pracownik 4', order: 4 },
      { name: 'Pracownik 5', order: 5 },
      { name: 'Pracownik 6', order: 6 },
      { name: 'Pracownik 7', order: 7 },
      { name: 'Pracownik 8', order: 8 },
      { name: 'Pracownik 9', order: 9 },
      { name: 'Pracownik 10', order: 10 },
      { name: 'Podwykonawcy zewnętrzni', order: 11 },
      { name: 'Materiały do obsługi', order: 12 },
      { name: 'Logistyka/Wysyłka', order: 13 },
      { name: 'Opakowania', order: 14 },
      { name: 'Zwroty towarów', order: 15 },
      { name: 'Magazyn', order: 16 },
      { name: 'Import/Cło', order: 17 },
      { name: 'Inne koszty towarów', order: 18 },
    ],
  },
  {
    name: 'Travel',
