...
describe('public installation proxy boundary', () => {
  it.each(['/m/a'.repeat(43), '/m/token', '/api/public/installations/token', '/api/public/installations/token/autosave'])('does not require dashboard authentication for %s', (pathname) => {
